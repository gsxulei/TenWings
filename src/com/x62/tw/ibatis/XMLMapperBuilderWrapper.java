...
public class XMLMapperBuilderWrapper extends XMLMapperBuilder
{
	...
	public XMLMapperBuilderWrapper(InputStream inputStream,Configuration configuration,String resource,
			Map<String,XNode> sqlFragments,ClassLoader classLoader)
	{
	...
	{
		System.out.println("*********bindMapperForNamespace");
		...
		try
		{
			boundType=classLoader.loadClass(namespace);
		}
	...
	protected Class<?> resolveClass(String alias)
	{
		...
		try
		{
			return classLoader.loadClass(alias);
		}
		catch(Exception e)
		{
			e.printStackTrace();
